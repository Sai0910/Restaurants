...
public class UserService {
  ...
  public List<UsersEntity> getAllUsers() {
    return entityManager
      .createQuery("SELECT u FROM UsersVO u", UsersEntity.class)
      .getResultList();
  }

  // Find a user by username
  public Optional<UsersEntity> findByUserName(String userName) {
    List<UsersEntity> result = entityManager
      .createQuery(
        "SELECT u FROM UsersVO u WHERE u.userName = :userName",
        UsersEntity.class
      )
  ...
  public boolean existsByUserName(String userName) {
    Long count = entityManager
      .createQuery(
        "SELECT COUNT(u) FROM UsersVO u WHERE u.userName = :userName",
        Long.class
      )
      .setParameter("userName", userName)
      .getSingleResult();
